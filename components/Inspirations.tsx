            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        />
                        <h2 className="mt-4 text-[24px] font-bold text-ltblack">Dining</h2>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            className="w-full max-w-[300px] h-auto"
                        />
                        <h2 className="mt-4 text-[24px] font-bold text-ltblack">Living</h2>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <Image
                            ...
                            className="w-full max-w-[300px] h-auto"
                        />
                        <h2 className="mt-4 text-[24px] font-bold text-ltblack">Bedroom</h2>
                    </div>
                </div>
            </div>
        </div>
